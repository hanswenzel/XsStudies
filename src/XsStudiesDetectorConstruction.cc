...
void XsStudiesDetectorConstruction::SetWorldMaterial(G4Material* wm) {
    this->worldMaterial = wm;
}

G4Material* XsStudiesDetectorConstruction::GetWorldMaterial() const {
    return worldMaterial;
}


G4Material* XsStudiesDetectorConstruction::GetTargetMaterial() const {
    return targetMaterial;
}


G4double XsStudiesDetectorConstruction::GetTargetLength() const {
    return targetLength;
}

void XsStudiesDetectorConstruction::SetRadius(G4double r) {
    this->radius = r;
}

G4double XsStudiesDetectorConstruction::GetRadius() const {
    return radius;
}

void XsStudiesDetectorConstruction::SetDetectorConstructionMessenger(XsStudiesDetectorConstructionMessenger* dm) {
    this->detectorMessenger = dm;
}

XsStudiesDetectorConstructionMessenger* XsStudiesDetectorConstruction::GetDetectorConstructionMessenger() const {
    return detectorMessenger;
}

void XsStudiesDetectorConstruction::SetLogicWorld(G4LogicalVolume* lW) {
    this->logicWorld = lW;
}

G4LogicalVolume* XsStudiesDetectorConstruction::GetLogicWorld() const {
    return logicWorld;
}

void XsStudiesDetectorConstruction::SetLogicTarget(G4LogicalVolume* lT) {
    this->logicTarget = lT;
}

G4LogicalVolume* XsStudiesDetectorConstruction::GetLogicTarget() const {
    return logicTarget;
}
...
G4double XsStudiesDetectorConstruction::GetDensity() const {
    return density;
}
